...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(3, 30, 1829);
	    assertEquals("3/31/1829", string0);
	}
	...
	public void testRunWithZeroAndZero() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(0, 0, 31);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate16() throws Throwable {
	    NextDate nextDate0 = new NextDate(30, 30, 30);
	    String string0 = nextDate0.run(10, 30, 1923);
	    assertEquals("10/31/1923", string0);
	}

	@Test(timeout = 4000)
	public void testCreatesNextDate15() throws Throwable {
	    NextDate nextDate0 = new NextDate(21, 21, 21);
	    String string0 = nextDate0.run(8, 21, 1820);
	    assertEquals("8/22/1820", string0);
	}
